...
const { create, attach, detach, read, list, rename, trash, restore, order, add, remove, deleteSmartTables, toggleSourceTable } = require('../controllers/smart-tables');
...
router.post('/source-tables/attach', [getSmartTableData, getValidSourceTables], attach);
router.post('/source-tables/detach', detach);
router.post('/source-tables/toggle', toggleSourceTable);
